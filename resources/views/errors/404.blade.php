...
<body>
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            ...
            <div class="mt-4">
                <img src="{{ asset('vuexy/assets/img/illustrations/page-misc-error.png') }}" alt="page-misc-error" width="225"
                    class="img-fluid" />
            </div>
        </div>
    </div>
    <div class="container-fluid misc-bg-wrapper">
        <img src="{{ asset('vuexy/assets/img/illustrations/bg-shape-image-light.png') }}" alt="page-misc-error"
